...
<body>
    <div class="container">
        ...
        <form action="../controller/modifier.php" method="post">
            ...
            if ($contact) 
            { // Vérifiez s'il y a un enregistrement
            ?>
                ...
                <div class="form-group">
                    ...
                    <input type="tel" id="numero_telephone" name="numero_telephone" value="<?php echo $contact['numero_telephone']; ?>">
                </div>
                <div class="form-group">
                    <label for="favori">Favori :</label>
                    <select id="favori" name="favori">
                        <option value="oui" <?php if ($contact["favori"] == 'oui') echo 'selected'; ?>>Oui</option>
                        <option value="non" <?php if ($contact["favori"] == 'non') echo 'selected'; ?>>Non</option>
                    </select>
                </div>
